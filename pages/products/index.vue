          ...
          <div class="col-12">
            <div class="product-info">
              ...
              <div id="myTabContent" class="tab-content">
                ...
                <!--/ End Single Tab -->
                <!-- Start Single Tab -->
                <div id="women" class="tab-pane fade" role="tabpanel">
                  <div class="tab-single">
                    <div class="row">
                      <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                        <div class="single-product">
                ...
                <!--/ End Single Tab -->
                <!-- Start Single Tab -->
                <div id="kids" class="tab-pane fade" role="tabpanel">
                  <div class="tab-single">
                    <div class="row">
                      <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                        <div class="single-product">
                ...
                <!--/ End Single Tab -->
                <!-- Start Single Tab -->
                <div id="essential" class="tab-pane fade" role="tabpanel">
                  <div class="tab-single">
                    <div class="row">
                      <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                        <div class="single-product">
